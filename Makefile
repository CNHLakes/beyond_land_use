...
manuscript/figures.pdf: manuscript/figures.Rmd figures/01_county_extent-1.pdf figures/02_hierarchical_demo-1.pdf figures/03_wetland_potential-1.pdf figures/04_nlcd-versus-cdl-1.pdf
