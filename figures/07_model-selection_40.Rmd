...
re_brms        <- readRDS("../data/mcmc/re_brms_40.rds")
...
```{r tn_re_hu4_40, fig.width = 3.77, fig.height = 4.5}
# setwd("figures")
...
hu4_all       <- st_crop(hu4_all, st_transform(study_bbox, st_crs(hu4_all)))
hu4_all       <- rmapshaper::ms_simplify(hu4_all)
...
```{r tn_re_compare_40, fig.height=3, fig.width=4}
...
```{r re-comparison_40, fig.width=4}
re_global <- dplyr::filter(re_global, term != "rowvcropvpct")
