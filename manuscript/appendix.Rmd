...
```{r nlcd-versus-cdl_map, fig.cap = "Example of increasing granularity for total Ag to Ag versus pasture, to pasture versus specific crops.", warning=FALSE, echo = FALSE, eval = TRUE}
