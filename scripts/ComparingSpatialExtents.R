...
county.ag                  <- lagos_select(table = "county.lulc", 
...
iws.ag <- lagos_select(table = "iws.lulc", vars = c("lagoslakeid", "iws_nlcd2006_pct_81", 
                                                    "iws_nlcd2006_pct_82"))
...
hu12.ag                <- lagos_select(table = "hu12.lulc", 
...
hu4.ag               <- lagos_select(table = "hu4.lulc", 
...
plot(ag.county.iws.hu12.hu4$hu4_totalag06 ~ ag.county.iws.hu12.hu4$hu12_totalag06, 
     ylab = "HU4", xlab = "County")

plot(ag.county.iws.hu12.hu4$hu4_totalag06 ~ ag.county.iws.hu12.hu4$hu12_totalag06, 
     xlab = "HU12 % Total Ag", ylab = "HU4 % Total Ag")
plot(ag.county.iws.hu12.hu4$hu4_totalag06 ~ ag.county.iws.hu12.hu4$hu12_totalag06, 
     xlab = "HU12 % Total Ag", ylab = "HU4 % Total Ag")
plot(ag.county.iws.hu12.hu4$hu4_totalag06 ~ ag.county.iws.hu12.hu4$hu12_totalag06, 
     xlab = "HU12 % Total Ag", ylab = "HU4 % Total Ag")
