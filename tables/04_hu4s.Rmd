...
hu4 <- lg$hu4 %>%
  ...
  compare_focal(focal_hu4s$hu4_zoneid)

dt        <- compare_focal(readRDS("../data/dt.rds"), focal_hu4s$hu4_zoneid)
dt_scaled <- compare_focal(readRDS("../data/dt_scaled.rds"), focal_hu4s$hu4_zoneid)                     
View(dt)
